...
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url('wp-login.php?action=register', 'login_post') ); ?>" method="post">
	...
	?>
	<p id="reg_passmail"><?php _e('Nous vous enverrons votre mot de passe par e-mail...Pensez à vérifier vos messages indésirables...!') ?></p> <!-- AO p id="reg_passmail"><?php _e('A password will be e-mailed to you.') ?></p-->
	<br class="clear" />
	<input type="hidden" name="redirect_to" value="<?php echo esc_attr( $redirect_to ); ?>" />
